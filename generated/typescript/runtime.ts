...
export function loadFrom(lookup: (key: string) => string | undefined): CliEnvValues {
  return {
    api_base: nonEmpty(lookup("DECLMIG_API_BASE")),
    config: nonEmpty(lookup("DECLMIG_CONFIG")),
    declmig_api_bind: nonEmpty(lookup("DECLMIG_API_BIND")),
    declmig_api_tcp_bind: nonEmpty(lookup("DECLMIG_API_TCP_BIND")),
    declmig_nats_url: nonEmpty(lookup("DECLMIG_NATS_URL")),
    json: (() => { const raw = lookup("DECLMIG_JSON"); return raw === undefined ? undefined : parseBool(raw, false); })(),
  };
}
...
export function loadEnvMap(
  ...
  const out: Record<string, string> = {};
  const api_base = pick(["DECLMIG_API_BASE"], ["flags", "env_shell", "env_file"], shell, dotenv, flags, undefined);
  if (api_base !== undefined) out["DECLMIG_API_BASE"] = api_base;
  const config = pick(["DECLMIG_CONFIG"], ["flags", "env_shell", "env_file"], shell, dotenv, flags, undefined);
  if (config !== undefined) out["DECLMIG_CONFIG"] = config;
  const declmig_api_bind = pick(["DECLMIG_API_BIND"], ["flags", "env_shell", "env_file"], shell, dotenv, flags, undefined);
  if (declmig_api_bind !== undefined) out["DECLMIG_API_BIND"] = declmig_api_bind;
  const declmig_api_tcp_bind = pick(["DECLMIG_API_TCP_BIND"], ["flags", "env_shell", "env_file"], shell, dotenv, flags, undefined);
  if (declmig_api_tcp_bind !== undefined) out["DECLMIG_API_TCP_BIND"] = declmig_api_tcp_bind;
  const declmig_nats_url = pick(["DECLMIG_NATS_URL"], ["flags", "env_shell", "env_file"], shell, dotenv, flags, undefined);
  if (declmig_nats_url !== undefined) out["DECLMIG_NATS_URL"] = declmig_nats_url;
  const json = pick(["DECLMIG_JSON"], ["flags", "env_shell", "env_file"], shell, dotenv, flags, undefined);
  if (json !== undefined) out["DECLMIG_JSON"] = json;
  return out;
}
